...
function CharacterDetail({ selectedId, addToFav, isItExist }) {
  ...
  useEffect(() => {
    async function getCharacter() {
      try {
        ...
        const episodesId = response.data.episode.map((item) =>
          item.split("/").pop()
        );
  ...
  if (loading)
    return <ReactLoading type="balls" color="#fff" width={100} height={100} />;
    ...
    <div className="character-detail">
      ...
      <div className="character-detail__info">
        ...
        <div className="actions">
          {isItExist ? (
            <p>this character already is in your favourites</p>
          ) : (
            <button
